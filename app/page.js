      ...
      <div style={{ maxWidth:1280, margin:"0 auto", padding:"5rem 1.5rem", position:"relative", zIndex:10, width:"100%" }}>
        <div className="hero-grid">
          ...
          <div style={{ animation:"fadeUp 0.8s ease forwards" }}>
            ...
            <h1 style={{ fontFamily:"'Playfair Display',Georgia,serif", color:"white", lineHeight:1.15, marginBottom:"1.5rem", fontSize:"clamp(2.2rem,5vw,3.8rem)" }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:16, animation:"fadeUp 0.8s 0.2s ease forwards", opacity:0 }}>
            ...
            <div className="hero-stats">
              {[
                { val:"500+", label:"Happy Patients", bg:"rgba(13,107,80,0.25)", border:"rgba(79,168,138,0.3)", color:"#E8A918" },
                ...
                <div key={label} style={{ borderRadius:16, padding:"1rem", textAlign:"center", background:bg, border:`1px solid ${border}` }}>
                  <div style={{ fontFamily:"'Playfair Display',serif", fontSize:"1.875rem", fontWeight:700, color }}>{val}</div>
      ...
      <div style={{ maxWidth:1280, margin:"0 auto", padding:"0 1.5rem" }}>
        <Reveal>
          <div style={{ maxWidth:768, margin:"0 auto", textAlign:"center" }}>
            ...
            <h2 style={{ fontFamily:"'Playfair Display',serif", fontSize:"clamp(1.8rem,4vw,2.5rem)", fontWeight:700, color:"#0A1628", marginBottom:"1.5rem" }}>
        ...
        <div className="why-grid" style={{ marginTop:"3rem" }}>
          ...
          <div style={{ display:"flex", alignItems:"center", justifyContent:"center" }}>
            <div style={{ textAlign:"center" }}>
              <div style={{ fontFamily:"'Playfair Display',serif", fontSize:"3.75rem", fontWeight:700, color:"#0D6B50" }}>VS</div>
      ...
      <div style={{ maxWidth:1280, margin:"0 auto", padding:"0 1.5rem" }}>
        <Reveal>
          <div style={{ textAlign:"center", marginBottom:"3.5rem" }}>
            ...
            <h2 style={{ fontFamily:"'Playfair Display',serif", fontSize:"clamp(1.8rem,4vw,2.5rem)", fontWeight:700, color:"#0A1628" }}>
      ...
      <div style={{ maxWidth:1280, margin:"0 auto", padding:"0 1.5rem" }}>
        <Reveal>
          <div style={{ textAlign:"center", marginBottom:"3.5rem" }}>
            ...
            <h2 style={{ fontFamily:"'Playfair Display',serif", fontSize:"clamp(1.8rem,4vw,2.5rem)", fontWeight:700, color:"white" }}>
    ...
    <section id="testimonials" style={{ padding:"5rem 0", background:"#FAFAF7" }}>
      <div style={{ maxWidth:1280, margin:"0 auto", padding:"0 1.5rem" }}>
        <Reveal><div style={{ textAlign:"center", marginBottom:"3.5rem" }}>
          ...
          <h2 style={{ fontFamily:"'Playfair Display',serif", fontSize:"clamp(1.8rem,4vw,2.5rem)", fontWeight:700, color:"#0A1628" }}>What Our Patients Say</h2>
        </div></Reveal>
        <div className="cards-grid">
          {items.map(({ initials, name, location, bg, color, text, note }) => (
            <Reveal key={name}>
              <div style={{ background:"white", borderRadius:20, padding:"2rem", border:"1px solid rgba(13,107,80,0.1)", position:"relative" }}>
                <div style={{ position:"absolute", top:16, left:24, fontFamily:"'Playfair Display',serif", fontSize:"5rem", color:"rgba(13,107,80,0.12)", lineHeight:1 }}>&ldquo;</div>
        ...
        <div className="trust-layout">
          <Reveal>
            <div>
              ...
              <h2 style={{ fontFamily:"'Playfair Display',serif", fontSize:"clamp(1.8rem,4vw,2.5rem)", fontWeight:700, color:"#0A1628", margin:"1.5rem 0 2rem" }}>
            ...
            <div>
              ...
              <div style={{ padding:"1.5rem", borderRadius:16, background:"#E8F4F0", border:"1px solid rgba(13,107,80,0.2)", display:"flex", alignItems:"center", gap:24 }}>
                <div style={{ width:110, height:110, border:"2px solid #0D6B50", borderRadius:"50%", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", textAlign:"center", flexShrink:0, background:"white", boxShadow:"0 8px 24px rgba(13,107,80,0.15)" }}>
                  <div style={{ fontFamily:"'Playfair Display',serif", fontSize:"1.5rem", fontWeight:700, color:"#0D6B50" }}>100%</div>
    ...
    <section id="doctors" style={{ padding:"5rem 0", background:"linear-gradient(135deg,#0A1628 0%,#0F2545 100%)" }}>
      <div style={{ maxWidth:1280, margin:"0 auto", padding:"0 1.5rem" }}>
        <Reveal><div style={{ textAlign:"center", marginBottom:"3.5rem" }}>
          ...
          <h2 style={{ fontFamily:"'Playfair Display',serif", fontSize:"clamp(1.8rem,4vw,2.5rem)", fontWeight:700, color:"white", margin:"1rem 0" }}>
          ...
          {[
            ...
            <Reveal key={title}>
              <div style={{ background:"linear-gradient(135deg,#0A1628 0%,#0F2545 100%)", borderRadius:24, border:`1px solid ${featured ? "rgba(232,169,24,0.4)" : "rgba(232,169,24,0.2)"}`, color:"white", padding:"2.5rem", position:"relative", overflow:"hidden" }}>
                ...
                <h3 style={{ fontFamily:"'Playfair Display',serif", fontSize:"1.25rem", fontWeight:700, color:"white", marginBottom:12 }}>{title.split("\n").map((l,i)=><span key={i}>{l}{i<1&&<br/>}</span>)}</h3>
                {content}
              </div>
            </Reveal>
          ))}
          ...
          <Reveal>
            <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
              ...
              <div style={{ borderRadius:16, padding:"1.5rem", background:"linear-gradient(135deg,#0A1628,#0F2545)" }}>
                ...
                {[["✓","#4FA88A","Free first consultation — no charges"],["✓","#4FA88A","Same-day or next-day appointment"],["✓","#4FA88A","Therapist comes to your home — anywhere in India"],["★","#E8A918","4.9/5 rating from 500+ patients"]].map(([icon, color, text]) => (
            ...
            <div style={{ borderRadius:24, padding:"2rem", background:"white", boxShadow:"0 20px 60px rgba(13,107,80,0.1)", border:"1px solid rgba(13,107,80,0.1)" }}>
              ...
              {submitted ? (
                <div style={{ textAlign:"center", padding:"2rem 0" }}>
                  ...
                  <h4 style={{ fontFamily:"'Playfair Display',serif", fontWeight:700, fontSize:"1.25rem", color:"#0D6B50", marginBottom:8 }}>Appointment Booked!</h4>
    ...
    <section style={{ padding:"5rem 0", background:"white" }}>
      <div style={{ maxWidth:768, margin:"0 auto", padding:"0 1.5rem" }}>
        <Reveal><div style={{ textAlign:"center", marginBottom:"3rem" }}>
          ...
          <h2 style={{ fontFamily:"'Playfair Display',serif", fontSize:"clamp(1.8rem,4vw,2.5rem)", fontWeight:700, color:"#0A1628" }}>Frequently Asked Questions</h2>
        </div></Reveal>
        <Reveal>
          {items.map(([q, a], i) => (
    ...
    <section style={{ padding:"5rem 0", background:"linear-gradient(135deg,#0A1628 0%,#063626 100%)", position:"relative", overflow:"hidden" }}>
      ...
      <Reveal>
        <div style={{ maxWidth:896, margin:"0 auto", padding:"0 1.5rem", textAlign:"center", position:"relative", zIndex:10 }}>
          ...
          <h2 style={{ fontFamily:"'Playfair Display',serif", fontSize:"clamp(2rem,5vw,3rem)", fontWeight:700, color:"white", marginBottom:24, lineHeight:1.2 }}>
    ...
    <footer style={{ background:"#04110A", color:"rgba(255,255,255,0.6)" }}>
      <div style={{ maxWidth:1280, margin:"0 auto", padding:"3rem 1.5rem" }}>
        <div className="footer-grid" style={{ marginBottom:32 }}>
          <div style={{ gridColumn:"span 2" }}>
            <div style={{ display:"flex", alignItems:"center", gap:12, marginBottom:16 }}>
              ...
              <div>
                <div style={{ fontFamily:"'Playfair Display',serif", fontWeight:700, color:"white", fontSize:"1.125rem" }}>Easy Movement</div>
        ...
        <div style={{ borderTop:"1px solid rgba(255,255,255,0.08)", paddingTop:24, display:"flex", flexWrap:"wrap", justifyContent:"space-between", alignItems:"center", gap:16 }}>
          <p style={{ fontSize:"0.75rem", color:"rgba(255,255,255,0.3)" }}>© 2025 Easy Movement. All rights reserved.</p>
    ...
    <div onClick={onClose} style={{ position:"fixed", inset:0, background:"rgba(10,22,40,0.85)", backdropFilter:"blur(6px)", zIndex:10000, display:"flex", alignItems:"center", justifyContent:"center", padding:16 }}>
      <div onClick={(e) => e.stopPropagation()} style={{ background:"white", borderRadius:24, maxWidth:640, width:"100%", maxHeight:"80vh", display:"flex", flexDirection:"column", boxShadow:"0 40px 80px rgba(0,0,0,0.3)", overflow:"hidden" }}>
        <div style={{ padding:"1.5rem 2rem", borderBottom:"1px solid rgba(13,107,80,0.1)", display:"flex", justifyContent:"space-between", alignItems:"center" }}>
          <div>
            <h2 style={{ fontFamily:"'Playfair Display',serif", fontWeight:700, fontSize:"1.25rem", color:"#0A1628" }}>Terms & Conditions</h2>
...
// ─── Page ──────────────────────────────────────────────────────────────────────
export default function EasyMovementPage() {
  const [termsOpen, setTermsOpen] = useState(false);
  return (
    <>
      <Head>
        <title>Easy Movement – Expert Home Physiotherapy | Pan India</title>
        <meta name="description" content="Best home physiotherapy across India. Certified experts, proven recovery, at your convenience. Available 24x7. Book now." />
      ...
      <style>{`
        *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
        ...
        body { font-family:'DM Sans',system-ui,sans-serif; background:#FAFAF7; color:#1a2e1a; overflow-x:hidden; }
